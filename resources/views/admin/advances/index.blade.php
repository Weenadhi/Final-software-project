...
<div class="content">
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="{{ route("advances.create") }}">
                    New Advance
                </a>
            </div>
        </div>
                                ...
                                @foreach($advances as $key => $advance)
                                    <tr data-entry-id="{{ $advance->id }}">
                                        ...
                                        <td>
                                                ...
                                                <form action="{{ route('advances.destroy', $advance->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('advances.massDestroy') }}",
